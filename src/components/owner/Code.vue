  ...
  <div class="pt-20">
    ...
    <form class="w-80 mx-auto text-center">
      ...
      <div class="d-grid gap-1 mt-4">
        <p v-if="Seconds > 9" class="text-center mb-5 text-blue-600">
          00:{{ Seconds }}
        </p>
        <p
          v-if="Seconds <= 9 && Seconds > 0"
          class="text-center mb-5 text-blue-600"
        >
          00:0{{ Seconds }}
        </p>
        <p v-if="Seconds <= 0" class="text-center mb-5 text-blue-600">
          ارسال مجدد کد
        </p>
      </div>
      <div class="text-center mb-6">
        <router-link class="text-center text-blue-600" to="/owner/verify"
