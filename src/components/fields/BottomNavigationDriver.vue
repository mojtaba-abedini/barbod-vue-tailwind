<template>
  <div class="w-full h-full">
    ...
    <section
      ...
      class="block fixed inset-x-0 bottom-0 z-10 bg-gradient-to-r from-green-500 to-green-700 shadow p-3 mx-auto"
    >
      <div id="tabs" class="flex justify-between">
        ...
        >
          <svg
            ...
            height="25"
            viewBox="0 0 42 42"
            class="inline-block mb-1 text-white"
          >
          ...
          <span class="tab tab-home block text-xs text-white">پروفایل</span>
        </router-link>
        <router-link
          to="/driver/cargo-list"
          class="
            w-full
            focus:text-teal-500
            hover:text-teal-500
        ...
        >
          ...
          <span class="tab tab-kategori block text-xs text-white">لیست بار</span>
        </router-link>
        <router-link
          to="/driver/my-cargo"
          class="
        ...
        >
          ...
          <span class="tab tab-explore block text-xs text-white">بار من</span>
        </router-link>
