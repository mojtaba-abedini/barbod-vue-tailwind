<template>
  <div class="w-full h-full">
    ...
    <section
      ...
      class="block fixed inset-x-0 bottom-0 z-10 bg-gradient-to-r from-cyan to-blue-600 shadow p-3 mx-auto"
    >
      <div id="tabs" class="flex justify-between">
        ...
        >
          ...
          <span class="tab tab-kategori block text-xs text-white">سفارش جدید</span>
        </router-link>
        <router-link
          to="/owner/orders"
          class="
        ...
        >
          ...
          <span class="tab tab-explore block text-xs text-white">سفارش ها</span>
        </router-link>
